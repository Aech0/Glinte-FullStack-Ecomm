...
function LoginInner() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      ...
      <p className="text-center text-ink-muted mb-8">Sign in to your Glinte account.</p>
      ...
      <p className="mt-6 text-center text-sm text-ink-muted">
        New to Glinte?{' '}
        <Link href={`/register${next !== '/' ? `?next=${encodeURIComponent(next)}` : ''}`} className="text-cherub-700 hover:underline">
          Create an account
        </Link>
      </p>
    </div>
